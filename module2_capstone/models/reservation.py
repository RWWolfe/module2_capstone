...
class Reservation(BaseModel):
    def __init__(
        self, reservation_id, site_id, reservation_name, from_date, to_date, create_date
    ):
    ...
    def campsite(self):
        ...
        if campsite_row:
            return Site(
                site_id=campsite_row.site_id,
                campground_id=campsite_row.campground_id,
                site_number=campsite_row.site_number,
                max_occupancy=campsite_row.max_occupancy,
                accessible=campsite_row.accessible,
                max_rv_length=campsite_row.max_rv_length,
                utilities=campsite_row.utilities,
            )
        else:
            return None
    ...
    @classmethod
    def create_new_reservation_in_sql(
        cls, site_id, reservation_name, from_date, to_date
    ):

        new_reservation = db.execute(
            text(
                """
